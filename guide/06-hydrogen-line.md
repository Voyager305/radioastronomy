...
Ожидаемая картина — схема (не реальные данные; здесь уместна реальная иллюстрация или скриншот):

```text
ON — антенна вдоль Млечного Пути:
   |          _____
   |        _/     \_
   |     __/         \__
   |  __/               \__
...
OFF — в стороне от галактической плоскости:
   |
...
Признак HI: «горб» присутствует на ON и отсутствует (или заметно слабее) на OFF. Из-за эффекта Доплера вершина может быть немного сдвинута относительно f₀. Ровная линия, одинаковая в обоих направлениях, — это фон или помеха, а не водород.
